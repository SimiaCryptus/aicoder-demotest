...
class CreateFileFromDescriptionActionTest : BaseActionTest() {
    ...
    fun testCreateFileFromDescription() = with(remoteRobot) {
        TestUtil.speak("Welcome to the AI Coder demo. We'll explore the 'Create File from Description' feature, which generates Kotlin files from natural language instructions.")
        log.info("Starting testCreateFileFromDescription")
        Thread.sleep(2000)

        step("Open project view") {
            TestUtil.speak("Opening the project view to navigate the project structure.")
        ...
        step("Open context menu") {
            TestUtil.speak("Navigating to the Kotlin source directory.")
        ...
        step("Click 'Create File from Description' action") {
            TestUtil.speak("Selecting 'Create File from Description' action.")
            waitFor(Duration.ofSeconds(30)) {
                ...
                try {
                    ...
                    TestUtil.speak("'Create File from Description' action initiated.")
                    true
                } catch (e: Exception) {
        ...
        step("Enter file description") {
            TestUtil.speak("Entering a natural language description for a new Kotlin data class.")
            waitFor(Duration.ofSeconds(10)) {
                try {
                    ...
                    TestUtil.speak("Description entered: Create a Kotlin data class named Person with properties: name (String), age (Int), and email (String).")
        ...
        step("Verify file creation") {
            TestUtil.speak("Verifying file creation in the project structure.")
            waitFor(Duration.ofSeconds(20)) {
                ...
                if (fileCreated) {
                    TestUtil.speak("Person.kt file successfully created.")
                }
                fileCreated
            }
            Thread.sleep(2000)
        ...
        step("Open created file") {
            TestUtil.speak("Opening the created file to examine its contents.")
        ...
        step("Verify file content") {
            TestUtil.speak("Verifying the content of the generated file.")
            ...
            waitFor(Duration.ofSeconds(5)) {
                ...
                if (contentCorrect) {
                    TestUtil.speak("File content verified: Person data class with specified properties created successfully.")
                }
                contentCorrect
            }
            Thread.sleep(2000)
        }
        TestUtil.speak("Demo concluded. The 'Create File from Description' feature successfully generated a Kotlin file from natural language input, demonstrating its potential to streamline development processes.")
        Thread.sleep(5000)
    }
