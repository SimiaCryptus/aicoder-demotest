...
class GenerateRelatedFileActionTest : BaseActionTest() {
    ...
    TestUtil.speak("This demo showcases the Generate Related File feature, converting a README.md to a reveal.js HTML presentation.")
        log.info("Starting testGenerateRelatedFile")
        Thread.sleep(3000)

        step("Open project view") {
        TestUtil.speak("Opening the project view.")
        ...
        TestUtil.speak("Selecting the README.md file.")
        ...
        TestUtil.speak("Opening the context menu.")
            val projectTree = find(JTreeFixture::class.java, byXpath("//div[@class='ProjectViewTree']"))
        ...
        TestUtil.speak("Selecting the AI Coder menu.")
        ...
        TestUtil.speak("Selecting 'Generate Related File' action.")
            waitFor(Duration.ofSeconds(10)) {
                try {
        ...
        TestUtil.speak("Entering the file generation directive.")
            waitFor(Duration.ofSeconds(10)) {
                try {
                    ...
                    TestUtil.speak("Directive entered: Convert this README.md into a reveal.js HTML presentation.")
                    ...
                    TestUtil.speak("Generation process initiated.")
                    true
                } catch (e: Exception) {
                    false
                }
            }
            TestUtil.speak("Waiting for file generation.")
        Thread.sleep(5000)
        }

        step("Verify file creation") {
        TestUtil.speak("Verifying file creation.")
            waitFor(Duration.ofSeconds(20)) {
                ...
                if (fileCreated) {
                    TestUtil.speak("presentation.html file successfully created.")
                }
                fileCreated
            }
            Thread.sleep(3000)
        ...
        TestUtil.speak("Demo concluded. The Generate Related File feature has converted README.md to a reveal.js HTML presentation.")
    Thread.sleep(10000)
    }
}